...
export const pricingModels: PricingModel[] = [
  {
    ...
    features: [
      ...
      'Launch support',
      'Updates after initial satisfactory design: $100/hr',
    ],
    highlighted: true,
  },
];
...
export const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      'Your package covers the build through a design you approve. After that, content edits, new sections, and changes are available at $100/hour.',
  },
  {
    id: '3',
  ...
  },
  {
    ...
    answer:
      'The $25/month covers hosting, core security, and keeping your site online. It does not include unlimited content or design changes after launch—those are billed at $100/hr once you have approved the initial design.',
  },
  {
    id: '5',
